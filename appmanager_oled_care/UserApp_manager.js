class UserAppManager {
    ...
    bindEvents() {
        ...
        }, true); // Use capture to ensure keys are always processed
    ...
    bindSettingsEvents() {
        ...
        this.opacitySlider.addEventListener('input', (e) => {
            ...
            this.applyOpacity();
            this.opacityValue.textContent = Math.round(this.settings.opacity * 100) + '%';
            this.saveSettings();
        });
    }
    ...
    applyOpacity() {
        this.sidebar.style.opacity = this.settings.opacity;
    }
    ...
    loadSettings() {
        try {
            ...
            this.opacitySlider.value = this.settings.opacity || 1.0;
            this.opacityValue.textContent = Math.round((this.settings.opacity || 1.0) * 100) + '%';
            this.applySettings();
        } catch (e) {
